...
const uint8_t I2C_SLAVE_ADDRESS = 0x30; /* I2C slave address */
const uint8_t I2C_REG1 = 0x0A;          /* Register 1 offset */
const uint8_t I2C_REG2 = 0x0B;          /* Register 2 offset */
const uint8_t I2C_START_DEV = 0x01;     /* Slave init value */
